...
submission: https://blackboard.umbc.edu/ultra/courses/_76209_1/outline/assessment/test/_6481225_1?courseId=_76209_1
---
...
2. __Communication__: Your report should be targeted at an audience who is familiar with AI but has not taken the class and knows nothing about what you have done so far. You can imagine your audience as either the readers of a technical blog post (if you took the AI system option) or as reviwers of a paper submission to an AI conference such as AAAI (if you took the research question option). You should aim to make your methods section clear enough that others could attempt to reproduce your work and your results section clear enough that readers understand exactly what experiments you ran.
